            ...
            <div className="mobile-menu-main">
                <div className="account-details">
                    <div className="mobile-menu-profile-link" onClick={handleProfileClick}>
                        ...
                        <span className="menu-display-name">{activeUser.displayName}</span>
                        <span className="menu-username">@{activeUser.username}</span>
                    </div>
                ...
                <div className="mobile-menu-links-container">
                    <ul>
                        <li className="mobile-menu-link-container">
                            <Link to={`/${activeUser.username}`} className="mobile-menu-link">
                        ...
                        <li className="mobile-menu-link-container">
                            <Link to={`/${activeUser.username}/lists`} className="mobile-menu-link">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#FFF">
                        ...
                        <li className="mobile-menu-link-container">
                            <Link to={`/${activeUser.username}/topics`} className="mobile-menu-link">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#FFF">
                        ...
                        <li className="mobile-menu-link-container">
                            <Link to={`/${activeUser.username}/bookmarks`} className="mobile-menu-link">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="#FFF">
